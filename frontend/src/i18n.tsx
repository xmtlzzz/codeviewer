...
const messages = {
  zh: {
    ...
    "header.refresh": "刷新仓库状态",
    "header.refreshing": "正在刷新仓库状态",
    ...
    "dashboard.rangeLabel": "统计范围",
    "dashboard.range.today": "今天",
    "dashboard.range.7d": "7 天",
    "dashboard.range.30d": "1 个月",
    "dashboard.rangeChartTitle": ({ range }: Params) => `${range}趋势`,
  ...
  en: {
    ...
    "header.refresh": "Refresh repository status",
    "header.refreshing": "Refreshing repository status",
    ...
    "dashboard.rangeLabel": "Stats range",
    "dashboard.range.today": "Today",
    "dashboard.range.7d": "7 days",
    "dashboard.range.30d": "1 month",
    "dashboard.rangeChartTitle": ({ range }: Params) => `${range} trend`,
